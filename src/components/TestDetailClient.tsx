...
interface TestDetailClientProps {
  ...
  relatedPackages: TestProfile[];
}

export default function TestDetailClient({ item, relatedPackages }: TestDetailClientProps) {
  ...
  const initialExpanded = profile.includedCategories && profile.includedCategories.length > 0
    ? [profile.includedCategories[0].categoryName]
    : [];
              ...
              <div className="space-y-6">
                ...
                {profile.includedCategories && profile.includedCategories.length > 0 && (
                  <div className="space-y-4">
                    {profile.includedCategories.map((cat, idx) => {
                ...
                {profile.includedTests && profile.includedTests.length > 0 && (
                  <div className="bg-brand-white border border-brand-charcoal/5 rounded-3xl p-6 sm:p-8 shadow-xs space-y-4">
                    ...
                    <div className="grid gap-3 sm:grid-cols-2">
                      {profile.includedTests.map((testName, index) => (
