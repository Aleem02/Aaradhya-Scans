...
export default function SEO() {
  const schemaData = {
    ...
    'name': 'Aaradhya Scans & Lab',
    'alternateName': 'Aaradhya Scans and Diagnostics',
    ...
    'logo': 'https://aaradhyascans.com/logo.png',
    'image': 'https://aaradhyascans.com/hero-preview.jpg',
    'telephone': '+919360933128',
    'email': 'info@aaradhyascans.com',
    'priceRange': '$$',
    'address': {
      '@type': 'PostalAddress',
