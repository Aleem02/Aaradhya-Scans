...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    title: `${service.name} Scan & Diagnostics | Aradhiya Scans`,
    description: `${service.shortDescription} Read patient preparation guidelines, scan procedure details, and who requires this diagnostic scan.`,
    alternates: {
              ...
              <div className="lg:sticky lg:top-24 bg-brand-white border border-brand-charcoal/5 rounded-3xl p-6 shadow-xs space-y-6">
                ...
                <div className="space-y-3">
                  <a
                    ...
                    className="w-full h-11 rounded-full text-[10px] font-bold uppercase tracking-wider text-brand-cream bg-brand-emerald hover:bg-brand-emerald-dark transition flex items-center justify-center gap-2 shadow-2xs hover:shadow-xs"
                  >
                ...
                {relatedServices.map((relatedService) => {
                  ...
                  return (
                    <div
                      ...
                      className="bg-brand-white border border-brand-charcoal/5 rounded-3xl p-6 flex flex-col justify-between h-auto group overflow-hidden shadow-md hover:shadow-xl hover:border-brand-emerald/20 transition-all duration-500 relative hover:-translate-y-1.5"
                    >
                      {/* Gold Accent Glow */}
